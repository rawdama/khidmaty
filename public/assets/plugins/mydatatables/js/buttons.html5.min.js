(function(j) {
    ...
    m.ext.buttons.copyHtml5 = {
        ...
        text: function(a) {
            return a.i18n("buttons.copy", "<i class='fa fa-files-o' style='color:#4ca906;'></i> نسخ")
        },
    ...
    m.ext.buttons.excelHtml5 = {
        ...
        text: function(a) {
            return a.i18n("buttons.excel", "<i class='fa fa-file-excel-o' style='color:#397d06;'></i> Excel")
        },
        action: function(a, c, d, b) {
            this.processing(!0);
            var e = this,
    ...
    m.ext.buttons.pdfHtml5 = {
        ...
        text: function(a) {
            return a.i18n("buttons.pdf", "<i class='fa fa-file-pdf-o' style='color:#9e0000;'></i> PDF")
        },
        action: function(a, c, d, b) {
            this.processing(!0);
            var e = this,
