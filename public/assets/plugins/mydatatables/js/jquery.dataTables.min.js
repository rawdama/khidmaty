...
(function(h) {
    ...
    function rb(a) {
        var b = a.oClasses,
            ...
            e = a.oPreviousSearch,
            f = a.aanFeatures,
            g = '<input type="search" class="' + b.sFilterInput + ' no-margin"/> <button type="button"  class=" btn btn-default  w-md no-margin "  id="addSearchInputs" ><i class="fa fa-search"></i> بحث متقدم  </button>',
            j = d.sSearch,
